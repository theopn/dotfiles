...
modules-left = powermenu filesystem memory temperature cpu network
modules-center = i3
modules-right = spotify pulseaudio backlight battery0 battery1 date
tray-position = left
...
format-diconnected-prefix-foreground = ${colors.disabled}
...
ramp-capacity-2 = 
ramp-capacity-3 = 
format-charging =  B0(Int) <label-charging>
format-discharging = <ramp-capacity> B0(Int) <label-discharging>
format-full =  B0(Int) <label-full>
...
ramp-capacity-2 = 
ramp-capacity-3 = 
format-charging =  B1(Ext) <label-charging>
format-discharging = <ramp-capacity> B1(Ext) <label-discharging>
format-full =  B1(Ext) <label-full>
