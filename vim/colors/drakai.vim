...
"             ▀          ▀
" Vim color file
" Mix of vim-monokai-tasty and Dracula for Vim
" OG Author: Dracula by dsifford, dsifford @ GitHub
"          : Monokai by patstockwell @ GitHub
" By theopn
" -----------------------------------------------------------------------------
...
let s:magenta = { 'cterm': 197, 'gui': '#FC649E' } " Keywords (Vim set, C include, sizeof, etc)
...
let s:white = { 'cterm': 231, 'gui': '#F8F8F2' } " Foreground text color
let s:light_grey = { 'cterm': 250, 'gui': '#bcbcbc' } " Not sure about its use
let s:grey = { 'cterm': 245, 'gui': '#8a8a8a' } " Comment text color
let s:dark_grey = { 'cterm': 59, 'gui': '#5f5f5f' }
let s:darker_grey = { 'cterm': 238, 'gui': '#444444' }
let s:light_charcoal = { 'cterm': 238, 'gui': '#2b2b2b' }
let s:charcoal = { 'cterm': 235, 'gui': '#282A35' } " BG Color
let s:dark_charcoal = { 'cterm' : 239, 'gui': '#424450' } " Custom color used for the cursor. Neither darker or charcoal
...
call Highlight('CursorColumn', { 'fg': s:none, 'bg': s:dark_charcoal, 'style': s:none })
call Highlight('ColorColumn', { 'fg': s:none, 'bg': s:dark_charcoal, 'style': s:none })
